...
var hebcal=function(e){"use strict";const t="5.9.0",n=[0,31,28,31,30,31,30,31,31,30,31,30,31],r=[n,n.slice()];
/*! @hebcal/hdate v0.13.5, distributed under GPLv2 https://www.gnu.org/licenses/gpl-2.0.txt */function o(e,t){return e-t*Math.floor(e/t)}function i(e,t){return Math.floor(e/t)}function a(e){return!(e%4||!(e%100)&&e%400)}function s(e,t){return r[+a(t)][e]}function u(e){return"object"==typeof e&&Date.prototype.isPrototypeOf(e)}function c(e,t,n){const r=e-1;return 365*r+i(r,4)-i(r,100)+i(r,400)+i(367*t-362,12)+(t<=2?0:a(e)?-1:-2)+n}function h(e){if(!u(e))throw new TypeError(`not a Date: ${e}`);return c(e.getFullYear(),e.getMonth()+1,e.getDate())}function l(e){if("number"!=typeof e)throw new TypeError(`not a Number: ${e}`);const t=function(e){const t=e-1,n=i(t,146097),r=o(t,146097),a=i(r,36524),s=o(r,36524),u=i(s,1461),c=i(o(s,1461),365),h=400*n+100*a+4*u+c;return 4!==a&&4!==c?h+1:h}(e=Math.trunc(e)),n=i(12*(e-c(t,1,1)+(e<c(t,3,1)?0:a(t)?1:2))+373,367),r=e-c(t,n,1)+1,s=new Date(t,n-1,r);return t<100&&t>=0&&s.setFullYear(t),s}
/*! @hebcal/hdate v0.13.5, distributed under GPLv2 https://www.gnu.org/licenses/gpl-2.0.txt */r[1][2]=29,e.greg=void 0,e.greg||(e.greg={}),e.greg.abs2greg=l,e.greg.daysInMonth=s,e.greg.greg2abs=h,e.greg.isDate=u,e.greg.isLeapYear=a;
/*! @hebcal/hdate v0.13.5, distributed under GPLv2 https://www.gnu.org/licenses/gpl-2.0.txt */
const f={NISAN:1,IYYAR:2,SIVAN:3,TAMUZ:4,AV:5,ELUL:6,TISHREI:7,CHESHVAN:8,KISLEV:9,TEVET:10,SHVAT:11,ADAR_I:12,ADAR_II:13},d="Nisan",g=["",d,"Iyyar","Sivan","Tamuz","Av","Elul","Tishrei","Cheshvan","Kislev","Tevet","Sh'vat"],m=[[...g,"Adar",d],[...g,"Adar I","Adar II",d]],y=new Map,v=-1373428;function S(e,t){if("number"!=typeof e||isNaN(e))throw new TypeError(`param '${t}' not a number: ${e}`)}function p(e,t,n){if(S(e,"year"),S(t,"month"),S(n,"day"),e<1)throw new RangeError(`hebrew2abs: invalid year ${e}`);let r=n;if(t<7){for(let t=7;t<=T(e);t++)r+=I(t,e);for(let n=1;n<t;n++)r+=I(n,e)}else for(let n=7;n<t;n++)r+=I(n,e);return v+E(e)+r-1}function w(e){return v+E(e)}function A(e){if(S(e,"abs"),(e=Math.trunc(e))<=v)throw new RangeError(`abs2hebrew: ${e} is before epoch`);let t=Math.floor((e-v)/365.24682220597794);for(;w(t)<=e;)++t;--t;let n=e<p(t,1,1)?7:1;for(;e>p(t,n,I(n,t));)++n;return{yy:t,mm:n,dd:1+e-p(t,n,1)}}function b(e){return(1+7*e)%19<7}function T(e){return+b(e)+12}function I(e,t){switch(e){case 2:case 4:case 6:case 10:case 13:return 29}return 12===e&&!b(t)||8===e&&!N(t)||9===e&&H(t)?29:30}function M(e,t){if(S(e,"month"),S(t,"year"),e<1||e>14)throw new TypeError(`bad monthNum: ${e}`);return m[+b(t)][e]}function E(e){const t=y.get(e);if("number"==typeof t)return t;const n=function(e){const t=e-1,n=235*Math.floor(t/19)+t%19*12+Math.floor((t%19*7+1)/19),r=204+n%1080*793,o=5+12*n+793*Math.floor(n/1080)+Math.floor(r/1080),i=r%1080+o%24*1080,a=1+29*n+Math.floor(o/24);let s=a;(i>=19440||2==a%7&&i>=9924&&!b(e)||1==a%7&&i>=16789&&b(t))&&s++;return s%7==0||s%7==3||s%7==5?s+1:s}(e);return y.set(e,n),n}function O(e){return E(e+1)-E(e)}function N(e){return O(e)%10==5}function H(e){return O(e)%10==3}
/*! @hebcal/hdate v0.13.5, distributed under GPLv2 https://www.gnu.org/licenses/gpl-2.0.txt */
const C=f.NISAN,D=f.CHESHVAN,_=f.KISLEV,k=f.TEVET,L=f.SHVAT,R=f.ADAR_I,Y=f.ADAR_II;function P(e){if(function(e){return"object"==typeof e&&null!==e&&"number"==typeof e.yy&&"number"==typeof e.mm&&"number"==typeof e.dd}(e))return e;if(u(e)){return A(h(e))}return A(e)}
/*! @hebcal/hdate v0.13.5, distributed under GPLv2 https://www.gnu.org/licenses/gpl-2.0.txt */
const j={"א":1,"ב":2,"ג":3,"ד":4,"ה":5,"ו":6,"ז":7,"ח":8,"ט":9,"י":10,"כ":20,"ל":30,"מ":40,"נ":50,"ס":60,"ע":70,"פ":80,"צ":90,"ק":100,"ר":200,"ש":300,"ת":400},B={};for(const[e,t]of Object.entries(j))B[t]=e;function F(e){const t=[];for(;e>0;){if(15===e||16===e){t.push(9),t.push(e-9);break}let n,r=100;for(n=400;n>e;n-=r)n===r&&(r/=10);t.push(n),e-=n}return t}function U(e){const t=parseInt(e,10);if(!t||t<0)throw new TypeError(`invalid number: ${e}`);let n="";const r=Math.floor(t/1e3);if(r>0&&5!==r){const e=F(r);for(const t of e)n+=B[t];n+="׳"}const o=F(t%1e3);if(1===o.length)return n+B[o[0]]+"׳";for(let e=0;e<o.length;e++)e+1===o.length&&(n+="״"),n+=B[o[e]];return n}function x(e){let t=0;const n=e.indexOf("׳");if(-1!==n&&n!==e.length-1){t+=1e3*x(e.substring(0,n)),e=e.substring(n)}for(const n of e){const e=j[n];"number"==typeof e&&(t+=e)}return t}
/*! @hebcal/hdate v0.13.5, distributed under GPLv2 https://www.gnu.org/licenses/gpl-2.0.txt */const Z={en:{infix:"within ",infix26:"within ",words:["","Lovingkindness","Might","Beauty","Eternity","Splendor","Foundation","Majesty"]},he:{infix:"שֶׁבְּ",infix26:"שֶׁבִּ",words:["","חֶֽסֶד","גְבוּרָה","תִּפאֶרֶת","נֶּֽצַח","הוֹד","יְּסוֹד","מַּלְכוּת"]},translit:{infix:"sheb'",infix26:"shebi",words:["","Chesed","Gevurah","Tiferet","Netzach","Hod","Yesod","Malkhut"]}};function $(e){if(e<1||e>49)throw new RangeError(`Invalid Omer day ${e}`)}function z(e){return[Math.floor((e-1)/7)+1,e%7||7]}function V(e,t){return $(e),"he"===t?function(e){const t=Math.floor(e/10),n=e%10;let r="הַיּוֹם ";11===e?r+="אַחַד "+te:12===e?r+="שְׁנֵים "+te:12<e&&e<20?r+=J[n]+" "+te:e>9&&(r+=J[n],n&&(r+=" ",r+=3===t?"וּ":"וְ"));e>2?((e>20||10===e||20===e)&&(r+=K[t]),r+=e<11?J[n]+" "+W+" ":" "+Q+" "):r+=1===e?ee+" ":q+" ";if(e>6){r=r.trim(),r+=", שְׁהֵם ";const t=Math.floor(e/7),n=e%7;r+=t>2?J[t]+" "+X+" ":1===t?"שָׁבֽוּעַ "+J[1]+" ":G+" "+X+" ",n&&(r+=2===n||3===n?"וּ":5===n?"וַ":"וְ",r+=n>2?J[n]+" "+W+" ":1===n?ee+" ":q+" ")}return r+="לָעֽוֹמֶר",r.normalize()}(e):function(e){const[t,n]=z(e),r=1===e?"day":"days";let o=`Today is ${e} ${r}`;if(t>1||7===e){const e=7===n,r=e?t:t-1;if(o+=`, which is ${r} ${1===r?"week":"weeks"}`,!e){o+=` and ${n} ${1===n?"day":"days"}`}}return o+" of the Omer"}(e)}const K=["","עֲשָׂרָה","עֶשְׂרִים","שְׁלוֹשִׁים","אַרְבָּעִים"],J=["","אֶחָד","שְׁנַיִם","שְׁלוֹשָׁה","אַרְבָּעָה","חֲמִשָּׁה","שִׁשָּׁה","שִׁבְעָה","שְׁמוֹנָה","תִּשְׁעָה"],G="שְׁנֵי",W="יָמִים",q=G+" "+W,X="שָׁבוּעוֹת",Q="יוֹם",ee=Q+" "+J[1],te="עָשָׂר";
/*! @hebcal/hdate v0.13.5, distributed under GPLv2 https://www.gnu.org/licenses/gpl-2.0.txt */
